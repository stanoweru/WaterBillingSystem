    ...
    <table width="100%" style="font-family: tahoma;font-size: 11;border: 0px!important;" class="table table-bordered statment" border="0">
          ...
          ?>
           ...
           <tr>
                ...
                <td class="tablehead right-align"><b><?php echo number_format(($billing->total_amount_due + $billing->arrears_amount + $billing->arrears_penalty_amount),2); ?></b></td>
           </tr>
           <tr>
                <td></td>
           ...
           <tr>
                ...
                <td class="tablehead right-align"><b><?php echo number_format(($billing->total_amount_due  + $billing->arrears_amount + $billing->arrears_penalty_amount+$billing->penalty_amount),2); ?></b></td>
           </tr>
   </table>
